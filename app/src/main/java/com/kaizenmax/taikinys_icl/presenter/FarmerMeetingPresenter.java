...
public class FarmerMeetingPresenter implements FarmerMeetingActivityPresenterInterface {
    MobileDatabase dbHelper =new MobileDatabase(FarmerMeetingActivity.getInstance());
    ...
    public String getMobileFromSharedpreference() throws Exception {
        ...
        String createdby="";
        SharedPreferences sharedpreferences = FarmerMeetingActivity.getInstance().getSharedPreferences(SharedPreferenceUtil.PREFERENCES, Context.MODE_PRIVATE);
    ...
    @Override
    public void insertFMdata(String activityName, String dateOfActivity, String noOfFarmers_entered,
                             String expenses_entered, String village_entered,
                             String selectedCropCategory, String selectedCropFocus,
                             String selectedMeetingPurpose, List<String> selectedProductsList,
                             String meetingHighlights, List<FarmerDetailsPojo> farmerDetailsPojoList,
                             ...
                             String faOfficeDistrict, List<byte[]> attachmentList) throws Exception {
        dbHelper.insertFMdata( activityName,  dateOfActivity,  noOfFarmers_entered,
                 expenses_entered,  village_entered,
                 selectedCropCategory,  selectedCropFocus,
                 selectedMeetingPurpose,  selectedProductsList,
                 meetingHighlights,  farmerDetailsPojoList,
