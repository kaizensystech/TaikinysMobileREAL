...
public class MyAdapter_ForDemoL3IdList extends RecyclerView.Adapter<MyAdapter_ForDemoL3IdList.ViewHolder> {
    ...
    public MyAdapter_ForDemoL3IdList(List<DemoL3ListItem> listItems, Context context) {
    ...
    @Override
    public void onBindViewHolder(MyAdapter_ForDemoL3IdList.ViewHolder holder, int position) {



        DemoL3ListItem listItem = listItems.get(position);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   if(stage.equals(CommonConstants.PROTOCOL.toString()))
                    ...
                    else if(stage.equals(CommonConstants.EXECUTION.toString()))
                    {

                        DemoL3_InProgressActivity.getInstance().execution_Intent(item.getDemoL3TempId());
                    }

                    else if (stage.equals(CommonConstants.RESULT_INTERIM.toString()))
                    {
